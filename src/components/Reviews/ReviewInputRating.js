...
const ReviewInputRating = (props) => {
    ...
    return (
        <div className="flex flex-row-reverse justify-between mt-4">
            <button onClick={props.onAddReviewHandler} type="submit" className='bg-teal-500 text-gray-50 rounded-xl px-3 py-1  transition duration-100 hover:opacity-90 active:animate-animeBtn'>Add review</button>
